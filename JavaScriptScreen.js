...
export default function JavaScriptScreen({navigation}) {
  return (
    <View>
      ...
      <Image source={{uri:("https://cadcampune.com/wp-content/uploads/2021/12/JAVA-SCRIPT-10.png")}}
    ...
    <View style={{backgroundColor:'white',height:500,width:410,borderRadius:10}}>
        ...
        <Text style={{color:'black',fontWeight:'bold',fontSize:40,margin:10}}>Javascript</Text>
